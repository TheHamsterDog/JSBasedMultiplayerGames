...
var typingRace_1 = __importDefault(require("./games/multiplayer/typingRace"));
var rollADice_1 = __importDefault(require("./games/multiplayer/rollADice"));
var rockPaperScissors_1 = __importDefault(require("./games/dual-player/rockPaperScissors"));
var uuid_1 = require("uuid");
var flipACoin_1 = __importDefault(require("./games/multiplayer/flipACoin"));
...
io.on("connection", function (socket) {
    ...
    socket.on('rock', function () {
        ...
        if (room.length > 0) {
            ...
            if (invalid_1) {
                socket.emit("error", { error: "You need to have exactly 2 players in your lobby to start a rock paper scissors game" });
            }
            else {
